...
export const STRINGS: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    addOrder: "+ Заказ",
    noAlarms: "Тревог нет",
    traffic: "Координация трафика",
    trafficHint: "Штатные события маршрутизации: робот уступил клетку другому и подождал один такт. Не является неисправностью.",
    ...
    liveOnly: "Только текущие данные (история БД недоступна)",
  },
  uz: {
    ...
    traffic: "Trafik muvofiqlashtiruvi",
    trafficHint: "Marshrutlashning odatiy hodisalari: robot katakni boshqasiga bo'shatib, bir takt kutdi. Nosozlik emas.",
    ...
    liveOnly: "Faqat joriy ma'lumotlar (BD tarixi mavjud emas)",
  },
  en: {
    ...
    addOrder: "+ Order",
    noAlarms: "No alarms",
    traffic: "Traffic coordination",
    trafficHint: "Routine routing events: a robot yielded a cell to another and waited one tick. Not a fault.",
    noOrders: "No orders",
    noRobots: "No robots",
    ...
    liveOnly: "Live data only (no persisted history)",
  },
};
